...
Used two ways:
* ``tests/server/`` imports it for route tests.
* ``python -m server --fake`` injects it so the web UI can be developed and
  the /v1 contract exercised without the bench hardware.
"""
